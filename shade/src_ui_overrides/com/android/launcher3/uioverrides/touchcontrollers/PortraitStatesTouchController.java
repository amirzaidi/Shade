...
public class PortraitStatesTouchController extends AbstractStateChangeTouchController {
    ...
    protected void setBlockTouch(boolean blockTouch) {
        mBlockTouch = blockTouch;
    }
    ...
    protected LauncherState getTargetState(LauncherState fromState, boolean isDragTowardPositive) {
        if (fromState == ALL_APPS && !isDragTowardPositive) {
            return mLauncher.getStateManager().getLastState();
        } else if (fromState == OVERVIEW) {
            return isDragTowardPositive ? ALL_APPS : NORMAL;
        } else if (fromState == NORMAL && isDragTowardPositive) {
            return mAllowDragToOverview ? OVERVIEW : ALL_APPS;
        }
        return fromState;
    }
    ...
    protected void onSwipeInteractionCompleted(LauncherState targetState, int logAction) {
        ...
        if (mStartState == NORMAL && targetState == OVERVIEW) {
            mLauncher.getStateManager().goToState(NORMAL, true /* animate */);
        }
    }

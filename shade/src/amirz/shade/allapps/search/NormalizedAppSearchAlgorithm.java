...
public class NormalizedAppSearchAlgorithm implements SearchAlgorithm {
    ...
    public static boolean matches(AppInfo info, String query, StringMatcher matcher) {
        return matches(info, query, matcher, false) ||
                matches(info, query, matcher, true);
    }

    private static boolean matches(AppInfo info, String query, StringMatcher matcher,
                                   boolean normalize) {
    ...
    private static String normalize(String in) {
        return complementaryGlyphs.matcher(Normalizer.normalize(in, Normalizer.Form.NFKD))
                .replaceAll("");
    }
    ...
    public static class StringMatcher {
        ...
        public static NormalizedAppSearchAlgorithm.StringMatcher getInstance() {
            return new NormalizedAppSearchAlgorithm.StringMatcher();
        }
    }
}
